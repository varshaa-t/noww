...
type UpwardRightArrowProps = {
  color: "#117640" | "#122a5b" | "#f9bc52";
  bgColor: "#f9bc52" | "#122a5b";
}

function UpwardRightArrow({color, bgColor}: UpwardRightArrowProps) {

  return (
    <svg width="56" height="56" viewBox="0 0 57 57" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="28.125" cy="28.125" r="28.125" fill={bgColor}></circle>
