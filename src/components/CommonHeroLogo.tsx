...
type CommonHeroLogoProps = {
    page: "about" | "services" | "process";
}

const pageClasses = {
    "about": "text-primary-yellow",
    "services": "text-[#e79e98]",
    "process": "text-medium-yellow"
  }

function CommonHeroLogo({ page }: CommonHeroLogoProps) {

  return (
    <svg className={`size-40 xs:size-44 lg:size-72 xl:size-80 ${pageClasses[page]}`} viewBox="0 0 183 332" fill="none" xmlns="http://www.w3.org/2000/svg">
