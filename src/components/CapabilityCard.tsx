...
function CapabilityCard({ title, number, variant, texts }: CapabilityCardProps) {
  ...
  return (
    <div className={`rounded-3xl flex flex-col space-y-6 w-full py-10 px-6 xs:px-8 sm:space-y-8 sm:py-12 md:px-10 lg:h-[420px] 2xl:py-14 ${variant == "filled" ? "bg-primary-yellow text-primary-blue h-[400px] sm:h-[450px]" : "text-primary-yellow bg-primary-blue border-4 border-primary-yellow h-[500px] xs:h-[480px] sm:h-[520px]"}`}>
